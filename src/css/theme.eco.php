...
.zen-menu ul li.parent.active > .zen-menu-heading:before {
  border-color: #4bb5c1 transparent transparent transparent;
}
...
.primary-row li {
  border-bottom: 1px solid #71c5ce;
}
.primary-row li a {
  color: #eeeeee;
}
...
.primary3-row li {
  border-bottom: 1px solid #97d4db;
}
.primary3-row li a {
  color: #eeeeee;
}
...
/*# sourceMappingURL=wp-content/themes/blankly/css/theme.eco.map */